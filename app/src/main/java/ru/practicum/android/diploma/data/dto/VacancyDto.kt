...
data class VacancyDto(
    ...
    // val adv_context: Any, TODO delete if not used
    // val adv_response_url: Any, TODO delete if not used
    ...
    val hasTest: Boolean,
    val id: String,
    // val insider_interview: Any, TODO delete if not used
    ...
    // val relations: List<Any>, TODO delete if not used
    @SerializedName("response_letter_required")
    val responseLetterRequired: Boolean,
    // val response_url: Any, TODO delete if not used
    val salary: SalaryDto,
    val schedule: ScheduleDto,
    @SerializedName("show_logo_in_search")
    val showLogoInSearch: Boolean,
    val snippet: SnippetDto,
    // val sort_point_distance: Any, TODO delete if not used
    val type: TypeDto,
    val url: String,
    // val working_days: List<Any>, TODO delete if not used
